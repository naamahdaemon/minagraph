...
assert.match(source, /if \(panelNode && graph\.hasNode\(panelNode\)\) showNodePanel\(panelNode, false\)/);
assert.match(source, /renderTransactionActionHeader\(node\)/);
assert.match(source, /renderTransactionActionHeader\(n\)/);
