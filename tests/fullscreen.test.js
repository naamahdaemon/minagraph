...
assert.match(source, /const qualifiedStageReveal = !touchStageClick \|\| Date\.now\(\) - lastQualifiedGraphTouchTapAt < 300;/);
assert.match(source, /if \(isFullscreen\) \{\s*event\.preventDefault\(\);\s*setFullscreenUiVisible\(!fullscreenUiVisible, \{ openSidebar: true \}\);/);
